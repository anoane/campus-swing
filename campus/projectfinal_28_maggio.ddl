...
CREATE TABLE Commento (ID int(11) NOT NULL AUTO_INCREMENT, Commento varchar(255), RootID int(11) NOT NULL, DocumentoID int(11) NOT NULL, UtenteID int(11) NOT NULL, PRIMARY KEY (ID)) ENGINE=InnoDB;
