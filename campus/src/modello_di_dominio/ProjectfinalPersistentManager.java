...
public class ProjectfinalPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Projectfinal";
	...
	private ProjectfinalPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProjectfinalPersistentManager();
		}
