 ...
 */
public class ZebraJListCWhite
    extends javax.swing.JList
{
    private java.awt.Color rowColors[] = new java.awt.Color[2];
    private boolean drawStripes = false;
 
    public ZebraJListCWhite( )
    {
    }
    public ZebraJListCWhite( javax.swing.ListModel dataModel )
    {
        super( dataModel );
    }
    public ZebraJListCWhite( Object[] listData )
    {
        super( listData );
    }
    public ZebraJListCWhite( java.util.Vector<?> listData )
    {
        super( listData );
    }
