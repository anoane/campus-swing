...
public class ModificaButton extends CustomButton {
	...
	protected static String iconPathOver = "./newimage/modificaOver.png";
	/**
	 * 
	 */
	public ModificaButton(String s) {
		super();
		setSize(52,52);
		setBackground(null);
		setLayout(null);
		...
		final JLabel lblRimuovi = new JLabel("Modifica");
		...
		this.addMouseListener(new MouseListener() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				lblX.setToolTipText("Modifica il documento");
				}
