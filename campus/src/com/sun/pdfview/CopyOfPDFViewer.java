 ...
 */
public class CopyOfPDFViewer extends JPanel
     ...
     */
    public CopyOfPDFViewer(boolean useThumbs) {
        //TODO:
    	/*super(TITLE);
...
//        System.out.println("Going to page " + pagenum);
    ...
    public void doOpen(String name) {
        try {
            ...
            try {
                ...
                Logger.getLogger(CopyOfPDFViewer.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    class PrintThread extends Thread {
        ...
        public void run() {
            try {
                ...
                JOptionPane.showMessageDialog(CopyOfPDFViewer.this,
    ...
    class PerformFullScreenMode implements Runnable {
        ...
        public void run() {
            ...
            fspp.addKeyListener(CopyOfPDFViewer.this);
            gotoPage(curpage);
